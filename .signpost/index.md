...
- [internal/assemble](./modules/assemble.md) — 6 go files; 54 exported symbols.
...
- [cmd/signpost](./modules/signpost.md) — 17 go files; 98 exported symbols; entrypoint main; package main.
