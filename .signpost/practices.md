...
- **Not declared.** Commit subjects follow no machine-readable convention — 1 of 157 read match the Conventional Commits shape. A message here is prose, so what a change was for has to be read rather than parsed.
  - Looked in the subject line of every commit read.
- 2 tags reachable from this commit, the most recent `v0.1.0` on 2026-08-01, 123 commits back.
