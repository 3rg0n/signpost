...
edges:
  ...
  - { kind: co_changes, to: ./okf.md, confidence: extracted, weight: 15 }
  ...
  - { kind: co_changes, to: ./signpost.md, confidence: extracted, weight: 46 }
  - { kind: co_changes, to: ./site.md, confidence: extracted, weight: 15 }
...
- **Changes with**: [internal/assemble](./assemble.md) ×19, [internal/discover](./discover.md) ×13, [internal/export](./export.md) ×3, [internal/extract](./extract.md) ×10, [internal/graph](./graph.md) ×5, [internal/hook](./hook.md) ×2, [internal/manifest](./manifest.md) ×10, [internal/model](./model.md) ×2, [internal/okf](./okf.md) ×15, [internal/practice](./practice.md) ×6, [internal/scaffold](./scaffold.md) ×2, [internal/semantic](./semantic.md) ×3, [cmd/signpost](./signpost.md) ×46, [site](./site.md) ×15, [internal/vcs](./vcs.md) ×6, [internal/view](./view.md) ×3
