...
edges:
  ...
  - { kind: co_changes, to: ./signpost.md, confidence: extracted, weight: 43 }
...
- **Changes with**: [internal/assemble](./assemble.md) ×17, [internal/discover](./discover.md) ×13, [internal/export](./export.md) ×2, [internal/extract](./extract.md) ×9, [internal/graph](./graph.md) ×3, [internal/hook](./hook.md) ×2, [internal/manifest](./manifest.md) ×8, [internal/model](./model.md) ×2, [internal/okf](./okf.md) ×13, [internal/practice](./practice.md) ×6, [internal/scaffold](./scaffold.md) ×2, [internal/semantic](./semantic.md) ×3, [cmd/signpost](./signpost.md) ×43, [site](./site.md) ×15, [internal/vcs](./vcs.md) ×6, [internal/view](./view.md) ×3
