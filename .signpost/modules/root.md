...
attributes:
  - { name: commits, value: "79" }
  - { name: entrypoints, value: "#!, param" }
  - { name: exported, value: "10" }
  - { name: files, value: "2" }
  - { name: first_commit, value: "2026-07-29" }
  - { name: last_commit, value: "2026-08-18" }
  - { name: lines_added, value: "5370" }
  - { name: lines_removed, value: "248" }
...
edges:
  ...
  - { kind: co_changes, to: ./signpost.md, confidence: extracted, weight: 51 }
  - { kind: co_changes, to: ./site.md, confidence: extracted, weight: 16 }
