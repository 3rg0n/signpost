...
attributes:
  ...
  - { name: lines_added, value: "4541" }
  - { name: lines_removed, value: "139" }
...
edges:
  ...
  - { kind: co_changes, to: ./signpost.md, confidence: extracted, weight: 31 }
...
- **Changes with**: [internal/assemble](./assemble.md) ×14, [internal/discover](./discover.md) ×11, [internal/extract](./extract.md) ×9, [internal/graph](./graph.md) ×2, [internal/hook](./hook.md) ×2, [internal/manifest](./manifest.md) ×6, [internal/model](./model.md) ×2, [internal/okf](./okf.md) ×9, [internal/practice](./practice.md) ×4, [internal/semantic](./semantic.md) ×3, [cmd/signpost](./signpost.md) ×31, [site](./site.md) ×13, [internal/vcs](./vcs.md) ×4
