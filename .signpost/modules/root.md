...
edges:
  ...
  - { kind: co_changes, to: ./extract.md, confidence: extracted, weight: 8 }
  ...
  - { kind: co_changes, to: ./signpost.md, confidence: extracted, weight: 30 }
...
- **Changes with**: [internal/assemble](./assemble.md) ×13, [internal/discover](./discover.md) ×10, [internal/extract](./extract.md) ×8, [internal/graph](./graph.md) ×2, [internal/hook](./hook.md) ×2, [internal/manifest](./manifest.md) ×6, [internal/model](./model.md) ×2, [internal/okf](./okf.md) ×9, [internal/practice](./practice.md) ×4, [internal/semantic](./semantic.md) ×3, [cmd/signpost](./signpost.md) ×30, [site](./site.md) ×12, [internal/vcs](./vcs.md) ×4
