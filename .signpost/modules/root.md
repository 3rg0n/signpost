...
edges:
  ...
  - { kind: co_changes, to: ./signpost.md, confidence: extracted, weight: 34 }
...
- **Changes with**: [internal/assemble](./assemble.md) ×17, [internal/discover](./discover.md) ×12, [internal/extract](./extract.md) ×9, [internal/graph](./graph.md) ×3, [internal/hook](./hook.md) ×2, [internal/manifest](./manifest.md) ×7, [internal/model](./model.md) ×2, [internal/okf](./okf.md) ×10, [internal/practice](./practice.md) ×5, [internal/semantic](./semantic.md) ×3, [cmd/signpost](./signpost.md) ×34, [site](./site.md) ×14, [internal/vcs](./vcs.md) ×4
