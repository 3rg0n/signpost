...
type: Module
title: cmd/signpost
description: 13 go files; 55 exported symbols; entrypoint main; package main.
resource: git://github.com/3rg0n/signpost@283dc9ef3bf7d3d943bdf49c808230f41c3da532/cmd/signpost
tags: [entrypoint]
...
attributes:
  ...
  - { name: lines_added, value: "3420" }
  - { name: lines_removed, value: "20" }
  - { name: package, value: main }
  - { name: top_author, value: 3rg0n }
  - { name: top_author_share, value: 67% }
edges:
  - { kind: co_changes, to: /modules/assemble.md, confidence: extracted, weight: 4 }
...
13 go files; 55 exported symbols; entrypoint main; package main.
<!-- /signpost:managed:summary -->
...
- **Changes with**: [internal/assemble](/modules/assemble.md) ×4, [internal/discover](/modules/discover.md) ×2, [internal/manifest](/modules/manifest.md) ×3, [internal/okf](/modules/okf.md) ×5, [internal/semantic](/modules/semantic.md) ×2, [site](/modules/site.md) ×2, [internal/vcs](/modules/vcs.md) ×4
