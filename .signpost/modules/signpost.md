...
resource: git://github.com/3rg0n/signpost@b9587fa84f48f6ac586fe7cac779743330511e45/cmd/signpost
tags: [entrypoint]
...
attributes:
  ...
  - { name: lines_added, value: "9258" }
  - { name: lines_removed, value: "283" }
...
edges:
  ...
  - { kind: co_changes, to: ./root.md, confidence: extracted, weight: 34 }
...
- **Changes with**: [internal/assemble](./assemble.md) ×17, [internal/discover](./discover.md) ×10, [internal/extract](./extract.md) ×5, [internal/manifest](./manifest.md) ×7, [internal/model](./model.md) ×2, [internal/okf](./okf.md) ×8, [internal/practice](./practice.md) ×5, [\(repository root\)](./root.md) ×34, [internal/semantic](./semantic.md) ×3, [site](./site.md) ×12, [internal/vcs](./vcs.md) ×4
