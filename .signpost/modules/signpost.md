...
type: Module
title: cmd/signpost
description: 27 go files; entrypoint main; package main.
resource: git://github.com/3rg0n/signpost@656e2ef6f7a45c7f3a5cc06d4a8139348acff5c7/cmd/signpost
tags: [entrypoint]
generated: { by: signpost/dev, at: "2026-08-17" }
attributes:
  - { name: commits, value: "51" }
  - { name: entrypoints, value: main }
  - { name: exported, value: "0" }
  - { name: files, value: "27" }
  - { name: first_commit, value: "2026-07-30" }
  - { name: last_commit, value: "2026-08-17" }
  - { name: lines_added, value: "13462" }
  - { name: lines_removed, value: "359" }
...
edges:
  ...
  - { kind: imports, to: ./graph.md, confidence: extracted, weight: 3, source: cmd/signpost/graph.go }
  ...
  - { kind: co_changes, to: ./root.md, confidence: extracted, weight: 50 }
...
27 go files; entrypoint main; package main.
<!-- /signpost:managed:summary -->
