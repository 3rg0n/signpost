...
type: Module
title: cmd/signpost
description: 19 go files; 118 exported symbols; entrypoint main; package main.
resource: git://github.com/3rg0n/signpost@1913961adad858aae9627dd6d27edcd500e90c00/cmd/signpost
tags: [entrypoint]
generated: { by: signpost/dev, at: "2026-08-09" }
attributes:
  - { name: commits, value: "33" }
  - { name: entrypoints, value: main }
  - { name: exported, value: "118" }
  - { name: files, value: "19" }
  - { name: first_commit, value: "2026-07-30" }
  - { name: last_commit, value: "2026-08-09" }
  - { name: lines_added, value: "9017" }
...
edges:
  ...
  - { kind: co_changes, to: ./root.md, confidence: extracted, weight: 32 }
...
19 go files; 118 exported symbols; entrypoint main; package main.
<!-- /signpost:managed:summary -->
...
- **Changes with**: [internal/assemble](./assemble.md) ×15, [internal/discover](./discover.md) ×10, [internal/extract](./extract.md) ×5, [internal/manifest](./manifest.md) ×7, [internal/model](./model.md) ×2, [internal/okf](./okf.md) ×7, [internal/practice](./practice.md) ×5, [\(repository root\)](./root.md) ×32, [internal/semantic](./semantic.md) ×3, [site](./site.md) ×12, [internal/vcs](./vcs.md) ×4
