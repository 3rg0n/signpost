...
edges:
  ...
  - { kind: co_changes, to: ./root.md, confidence: extracted, weight: 43 }
...
- **Changes with**: [internal/assemble](./assemble.md) ×17, [internal/discover](./discover.md) ×11, [internal/extract](./extract.md) ×5, [internal/manifest](./manifest.md) ×7, [internal/model](./model.md) ×2, [internal/okf](./okf.md) ×11, [internal/practice](./practice.md) ×6, [\(repository root\)](./root.md) ×43, [internal/scaffold](./scaffold.md) ×2, [internal/semantic](./semantic.md) ×3, [site](./site.md) ×13, [internal/vcs](./vcs.md) ×6, [internal/view](./view.md) ×3
